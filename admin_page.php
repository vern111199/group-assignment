...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-4 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 ms-5 fs-3" href="#">Company name</a>
  <button class="navbar-toggler position-absolute d-md-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3 fs-3" href="#">Sign out</a>
    </div>
  </div>
</header>
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item nav-item-text py-4">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h1 px-5">Dashboard</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-outline-secondary px-lg-2 px-4">Share</button>
            <button type="button" class="btn btn-sm btn-outline-secondary px-lg-2 px-4">Export</button>
          </div>
          <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle px-lg-2 px-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="dashboard-section">
              ...
              <div class="dashboard-text">
                <div>
                  <p class="dashboard-main-text">300</p>
                  <p class="dashboard-sub-text">Users</p>
                </div>
              </div>
            </div>
          </div>
